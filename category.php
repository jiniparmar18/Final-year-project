            ...
            <div class="home">
                <div class="home_container d-flex flex-column align-items-center justify-content-end">
                    <div class="home_content text-center">
                        <div class="home_title"> Women Category </div>
                    ...
                    <div class="row products_bar_row">
                        <div class="col">
                            <div
                                ...
                                <div
                                    class="products_bar_side d-flex flex-row align-items-center justify-content-start ml-lg-auto">
                                    <div class="products_dropdown product_dropdown_sorting">
                                        ...
                                        <ul>
                                            <li class="item_sorting_btn"
                                                data-isotope-option='{ "sortBy": "original-order" }'>Default</li>
                    ...
                    <div class="row products_row products_container grid">
                        <?php
                            ...
                            if(isset($_GET['cat'])){
                                ...
                                $query = "SELECT * FROM products  where p_cat='Women' and cat_id=$cat_id LIMIT $start_from, $per_page";
                                ...
                                while($row_products=mysqli_fetch_array($result)){
                                    ...
                                    <div class='product'>
										...
										<form action='category.php?add_wish=$pro_id' method='post'><button class='add-btn' name='wish'><div><div>WISHLIST</div></div></button></form>
										</div>
									
										<div class='product_button product_cart text-center d-flex flex-column align-items-center justify-content-center'>
										<form action='category.php?add_cart=$pro_id' method='post'><button class='add-btn' name='cart'><div><div>ADD TO CART</div></div></button> </form>
										</div>
                            ...
                            ";
                                ...
                                $start_from = ($page-1)*$per_page;
                                $query = "SELECT * FROM products  where p_cat='Women' LIMIT $start_from, $per_page";
                                    ...
                                    <div class='product'>
                                        ...
                                        <div class='product_content'>
                                            <div class='product_info d-flex flex-row align-items-start justify-content-start'>
                                                ...
                                                <div class='ml-auto text-right'>
                                                    <div class='product_price text-right'>Rs $pro_price</div>
                                                </div>
                                            </div>
					...
					<div class="col">
						<div class="page_nav">
				            ...
				            <?php
                                    ...
                                    $query = "select * from products where p_cat='Women'";
                            ...
                            <div class="col-lg-4 footer_col">
                                <div class="footer_about">
                                    ...
                                    <div class="footer_about_text">
                                        <p>Great skin is possible with the right skin care, routine and consistency.
